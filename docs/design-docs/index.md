...
- **[browser-debugging.md](browser-debugging.md)** — How to debug jidoka's rendered HTML. Verdict: Chrome DevTools MCP for debugging, Playwright MCP for automation; skip Browser-Use CLI.
