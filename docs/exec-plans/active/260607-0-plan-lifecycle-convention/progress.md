...
**Cursor:** 05-portable-convention-doc (next). Units 01–04 done — see Done below.
...
- **Post-compaction resume:** read this file first. State (2026-06-07) = bootstrap **done**, pre-execution review **done**, **Units 01–04 done** (squash-merged on the plan branch). **Next action = Unit 05 — Write the portable `docs/CONVENTION.md`** (it satisfies the forward-refs to `CONVENTION.md` already committed in root `AGENTS.md` + `docs/exec-plans/AGENTS.md`), on a `unit/05-…` branch inside `worktrees/260607-0-plan-lifecycle-convention/`. Do NOT re-run the Bootstrap or pre-review.
