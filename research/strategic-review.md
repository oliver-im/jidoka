...
Pre-implementation review of four strategic risks before investing in building planview.
...
The two tools could coexist — visual-explainer for general visualization, planview for multi-agent planning. No overlap in purpose.
...
The renderer binary (`echo JSON | planview` → HTML) has zero Claude dependency.
